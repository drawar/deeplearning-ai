...
$ floyd clone deeplearningai/projects/python-basics-with-numpy/2
```
...
- Note that changes you make to the notebook running on Floyd servers are not going to be saved at your local directory, but they are going to be available in the [output](https://www.floydhub.com/deeplearningai/projects/python-basics-with-numpy/2/output) section of your job.
