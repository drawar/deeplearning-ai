...
$ floyd clone deeplearningai/projects/logistic-regression/4
```
...
- Note that changes you make to the notebook running on Floyd servers are not going to be saved at your local directory, but they are going to be available in the [output](https://www.floydhub.com/deeplearningai/projects/logistic-regression/4/output) section of your job.
