...
$ floyd clone deeplearningai/projects/building-deep-neural-network/1
```
...
- Note that changes you make to the notebook running on Floyd servers are not going to be saved at your local directory, but they are going to be available in the [output](https://www.floydhub.com/deeplearningai/projects/building-deep-neural-network/1/output) section of your job.
